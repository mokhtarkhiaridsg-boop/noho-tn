...
const DOORS = [
  {
    ...
    hook: "Reçois Amazon, Shein, eBay — on consolide, on expédie l Tounes.",
    tag: "dès 35 TND/mois",
    Icon: AiMailbox,
  },
  {
...
/* ═══════════════════════════════════════════════════════════════════
   DASHBOARD SNIPPET — floating member-dashboard card, same move as
   nohomailbox.org's homepage, TN-flavored.
   ═══════════════════════════════════════════════════════════════════ */
    ...
    >
      ...
      <div className="rounded-lg p-1.5 mb-1 flex items-center gap-1.5" style={{ background: "#FBF7F0", border: "1px solid #F0E7D8" }}>
        ...
        <div className="min-w-0">
          <p className="text-[9px] font-black truncate leading-tight" style={{ color: INK }}>UPS · Colis reçu</p>
          <p className="text-[7.5px] leading-tight" style={{ color: "#7A6050" }}>Scan · Expédie l Tounes</p>
        </div>
      </div>
      <div className="rounded-lg p-1.5 flex items-center gap-1.5" style={{ background: "#FBF7F0", border: "1px solid #F0E7D8" }}>
        ...
        <div className="min-w-0">
          <p className="text-[9px] font-black truncate leading-tight" style={{ color: INK }}>Lettre · scannée</p>
          <p className="text-[7.5px] leading-tight" style={{ color: "#7A6050" }}>PDF sur ton dashboard</p>
        </div>
      </div>
    </div>
  );
...
/* ═══════════════════════════════════════════════════════════════════
   ...
   One viewport on desktop; after this, carriers then footer.
   ═══════════════════════════════════════════════════════════════════ */
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[minmax(0,0.76fr)_minmax(0,1.24fr)] gap-9 sm:gap-5 lg:gap-9 items-center">
          ...
          <div className={`reveal-zoom ${mounted ? "is-in" : ""} relative max-w-[660px] w-full mx-auto sm:mx-0 sm:justify-self-end pb-5`} style={{ ["--reveal-delay" as string]: "140ms" }}>
            <div className="relative">
              ...
              <img
                src="/storefront.jpg"
                alt="Le storefront NOHO au 5062 Lankershim Blvd, North Hollywood, CA"
