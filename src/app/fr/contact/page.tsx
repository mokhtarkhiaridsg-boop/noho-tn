...
const breadcrumbs = breadcrumbJsonLd([
  ...
  { name: "Contact", url: "https://nohomailboxtunis.com/fr/contact" },
]);
...
const contactJsonLd = {
  ...
  url: "https://nohomailboxtunis.com/fr/contact",
  inLanguage: "fr-TN",
  mainEntity: {
    "@type": "Organization",
    ...
    <>
      ...
      <section className="px-5 sm:px-6 py-12 sm:py-14" style={{ background: "#fff" }}>
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <a
            href="mailto:hello@nohomailbox.org?subject=Demande%20d%27information%20depuis%20nohomailboxtunis.com"
            className="block p-7 rounded-3xl transition-all hover:scale-[1.02]"
