...
const breadcrumbs = breadcrumbJsonLd([
  ...
  { name: "Expédition", url: "https://nohomailboxtunis.com/fr/shipping" },
]);
          ...
          >
            ...
            <div className="relative z-[1]">
              <p className="text-[9.5px] font-bold uppercase tracking-[0.16em] mb-1" style={{ color: BLUE }}>
                Labels live · tarifs transporteurs réels
              </p>
              <h2
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="p-7 rounded-3xl" style={{ background: "#fff", border: "1px solid rgba(45,16,15,0.08)" }}>
            ...
            <div className="flex flex-col gap-3">
              ...
              <a
                href="mailto:hello@nohomailbox.org?subject=Devis%20expedition%20depuis%20nohomailboxtunis.com&body=Bonjour%2C%0A%0AJ%27aimerais%20un%20devis%20d%27expedition%20depuis%20Los%20Angeles%20vers%20la%20Tunisie.%0A%0AAdresse%20origine%20%3A%0AAdresse%20destination%20(Tunisie)%20%3A%0APoids%20(kg)%20%3A%0ADimensions%20(L%20%C3%97%20l%20%C3%97%20h%20cm)%20%3A%0AValeur%20declaree%20(USD)%20%3A%0AContenu%20%3A%0ADelai%20souhaite%20%3A%0A%0AMerci."
                className="inline-flex items-center justify-center gap-2 font-black px-6 py-4 rounded-xl text-[14.5px] transition-all hover:scale-[1.02] text-center"
                style={{ background: INK, color: CREAM }}
              >
