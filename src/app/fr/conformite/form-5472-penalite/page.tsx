...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nohomailboxtunis.com/fr/conformite/form-5472-penalite" },
};
      ...
      <section className="px-5 sm:px-6 pt-12 sm:pt-20 pb-10 sm:pb-12" style={{ background: CREAM }}>
        <div className="max-w-3xl mx-auto">
          <nav className="text-[12px] mb-5 opacity-60" style={{ color: INK }}>
            <Link href="/fr" className="hover:underline">Accueil</Link> · <span>Conformité</span> · <span>Form 5472</span>
          </nav>
