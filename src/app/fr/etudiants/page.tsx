...
const breadcrumbs = breadcrumbJsonLd([
  ...
  { name: "Étudiants", url: "https://nohomailboxtunis.com/fr/etudiants" },
]);
    ...
    <>
      ...
      >
        ...
        <div className="relative max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] items-center gap-10">
          ...
          <div>
            ...
            <p className="font-black text-[15px] sm:text-[16px] mb-4" style={{ color: GREEN }}>
              Ndezzou m3ak fel dossier US.
            </p>
            <p
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-6">
              ...
              <WhatsAppCTA
                intent="etudiant"
                className="!px-7 !py-4"
                style={{ boxShadow: "0 4px 0 rgba(0,0,0,0.25), 0 10px 30px rgba(45,122,74,0.25)" }}
              >
                WhatsApp — projet d&apos;études
              </WhatsAppCTA>
            </div>
            <OpenStatusPill />
          </div>
      ...
      <section className="px-5 sm:px-6 py-16 sm:py-20" style={{ background: "#FFFFFF" }}>
        <div className="max-w-3xl mx-auto">
          ...
          >
            L&apos;adresse US dans ton parcours étudiant.
          </h2>
          <div className="space-y-5 text-[15.5px] leading-[1.7]" style={{ color: "rgba(45,16,15,0.82)" }}>
            <p>
              <strong className="font-black" style={{ color: INK }}>Le Form I-20 est émis après ton admission.</strong>{" "}
              L&apos;université émet ton I-20 (document d&apos;éligibilité
              SEVIS). Selon l&apos;école, il peut être transmis par voie
              électronique ou par courrier. Tu dois présenter ton Form I-20 lors
              de ton entretien de visa F-1 — une adresse US stable aide à
              recevoir ton courrier universitaire et à fiabiliser ton dossier.
            </p>
            <p>
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <Link
                  href="/fr/blog/etudiant-tunisien-arrivee-us-checklist-30-jours"
                  className="inline-flex items-center justify-center gap-2 font-black px-8 py-4 rounded-2xl text-[15px] transition-transform duration-200 hover:-translate-y-0.5 cursor-pointer focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#337485]/30"
                  style={{
                    background: "#FFFFFF",
                    color: INK,
