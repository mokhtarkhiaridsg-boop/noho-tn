...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `https://nohomailboxtunis.com/blog/categorie/${category}` },
  };
}
...
export default async function CategoryPage({
  ...
  const breadcrumbs = breadcrumbJsonLd([
    ...
    { name: "Blog", url: "https://nohomailboxtunis.com/fr/blog" },
    { name: meta.label, url: `https://nohomailboxtunis.com/blog/categorie/${category}` },
  ]);
