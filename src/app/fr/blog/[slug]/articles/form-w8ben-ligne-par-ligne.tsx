    ...
    <>
      ...
      <ul>
        ...
        <li>
          ...
          <Link href="/fr/blog/w8ben-vs-w9-non-us-person" className="font-bold underline" style={{ color: "#337485" }}>
      ...
      <ul>
        ...
        <li>
          ...
          <Link href="/fr/blog/itin-w7-vs-caa-fondateur-tunisien" className="font-bold underline" style={{ color: "#337485" }}>
            ITIN W-7 vs CAA
          </Link>
          .
        </li>
