    ...
    <>
      ...
      <ul>
        ...
        <li>
          ...
          premier essai (cf.{" "}
          <Link href="/fr/blog/stripe-approval-9-item-stack-detail">
            détail stack
          </Link>
          ).
        </li>
      ...
      <ul>
        <li>
          ...
          <Link href="/fr/blog/paddle-lemonsqueezy-vs-stripe-direct-saas-tunisiens">
      ...
      <p>
        ...
        <Link href="/fr/blog/passer-noho-wyoming-vers-stripe-atlas-cas-inverse">
