...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nohomailboxtunis.com/fr/outils/comparateurs/cross-border" },
};
    ...
    <>
      ...
      <section className="px-5 sm:px-6 py-10 sm:py-14" style={{ background: "#fff" }}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="rounded-3xl overflow-hidden min-w-[560px] sm:min-w-0" style={{ background: "#fff", border: "1px solid rgba(45,16,15,0.08)", boxShadow: "0 12px 32px rgba(45,16,15,0.06)" }}>
