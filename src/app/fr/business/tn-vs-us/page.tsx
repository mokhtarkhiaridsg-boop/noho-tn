...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nohomailboxtunis.com/fr/business/tn-vs-us" },
};
    ...
    <>
      <section className="px-5 sm:px-6 pt-12 sm:pt-20 pb-10 text-center" style={{ background: CREAM }}>
        <div className="max-w-3xl mx-auto">
          <div className="text-[12px] mb-3" style={{ color: "rgba(45,16,15,0.55)" }}>
            ...
            <Link href="/fr/business" className="hover:underline">Solution Business</Link>
            <span className="mx-1.5">·</span>
            <span>TN vs US</span>
          </div>
          <h1
      ...
      <section className="px-5 sm:px-6 py-12 sm:py-16" style={{ background: "#fff" }}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="min-w-[560px] rounded-3xl overflow-hidden" style={{ background: "#fff", border: `1px solid rgba(45,16,15,0.08)`, boxShadow: "0 12px 32px rgba(45,16,15,0.06)" }}>
      ...
      <section className="px-5 sm:px-6 py-10" style={{ background: "#fef3c7" }}>
        <div className="max-w-3xl mx-auto text-[13.5px] leading-relaxed" style={{ color: "#422006" }}>
          ...
          <p>
            ...
            60 secondes,{" "}
            <Link href="/fr/diagnostic" className="font-bold underline" style={{ color: "#92400e" }}>
              à tester ici
            </Link>.
          </p>
        </div>
