...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nohomailboxtunis.com/ar/blog/cloudflare-r2-workers-pages-creator-tunisien" },
};

export default function ArCloudflarePage() {
  return (
    <ArabicStub
      frHref="/fr/blog/cloudflare-r2-workers-pages-creator-tunisien"
