...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nohomailboxtunis.com/ar/blog/shopify-payments-tunisie-vs-llc-us-route" },
};

export default function ArShopifyPaymentsPage() {
  return (
    <ArabicStub
      frHref="/fr/blog/shopify-payments-tunisie-vs-llc-us-route"
