...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nohomailboxtunis.com/ar/blog/paddle-lemonsqueezy-vs-stripe-direct-saas-tunisiens" },
};

export default function ArPaddleLemonSqueezyPage() {
  return (
    <ArabicStub
      frHref="/fr/blog/paddle-lemonsqueezy-vs-stripe-direct-saas-tunisiens"
