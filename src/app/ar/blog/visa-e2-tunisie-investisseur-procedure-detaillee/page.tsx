...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nohomailboxtunis.com/ar/blog/visa-e2-tunisie-investisseur-procedure-detaillee" },
};

export default function ArVisaE2Page() {
  return (
    <ArabicStub
      frHref="/fr/blog/visa-e2-tunisie-investisseur-procedure-detaillee"
