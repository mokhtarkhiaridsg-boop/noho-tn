...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://noho.tn/ar/blog/wyoming-delaware-nouveau-mexique-choisir-etat-llc" },
};

export default function ArWyDeNmPage() {
  return (
    <ArabicStub
      frHref="/blog/wyoming-delaware-nouveau-mexique-choisir-etat-llc"
