...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nohomailboxtunis.com/ar/blog/wise-business-multi-currency-flow-optimal" },
};

export default function ArWiseMultiCurrencyPage() {
  return (
    <ArabicStub
      frHref="/fr/blog/wise-business-multi-currency-flow-optimal"
