...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nohomailboxtunis.com/ar/blog/autoentrepreneur-tunisien-vs-llc-americaine" },
};

export default function ArAeVsLlcPage() {
  return (
    <ArabicStub
      frHref="/fr/blog/autoentrepreneur-tunisien-vs-llc-americaine"
