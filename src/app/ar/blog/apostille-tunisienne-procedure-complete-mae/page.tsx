...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nohomailboxtunis.com/ar/blog/apostille-tunisienne-procedure-complete-mae" },
};

export default function ArApostillePage() {
  return (
    <ArabicStub
      frHref="/fr/blog/apostille-tunisienne-procedure-complete-mae"
