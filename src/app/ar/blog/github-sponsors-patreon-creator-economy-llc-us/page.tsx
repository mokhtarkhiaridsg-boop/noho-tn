...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nohomailboxtunis.com/ar/blog/github-sponsors-patreon-creator-economy-llc-us" },
};

export default function ArGithubSponsorsPatreonPage() {
  return (
    <ArabicStub
      frHref="/fr/blog/github-sponsors-patreon-creator-economy-llc-us"
