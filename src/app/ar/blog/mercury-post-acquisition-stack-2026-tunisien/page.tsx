...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nohomailboxtunis.com/ar/blog/mercury-post-acquisition-stack-2026-tunisien" },
};

export default function ArMercuryPostAcquisitionPage() {
  return (
    <ArabicStub
      frHref="/fr/blog/mercury-post-acquisition-stack-2026-tunisien"
