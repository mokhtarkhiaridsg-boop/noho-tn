...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nohomailboxtunis.com/ar/outils/lookups/form-1583" },
};

export default function ArForm1583Page() {
  return <ArabicStub frHref="/fr/outils/lookups/form-1583" frTitleAr="Form 1583 USPS — التحقق والتوثيق" />;
}
