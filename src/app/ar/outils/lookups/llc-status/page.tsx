...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nohomailboxtunis.com/ar/outils/lookups/llc-status" },
};

export default function ArLlcLookupPage() {
  return <ArabicStub frHref="/fr/outils/lookups/llc-status" frTitleAr="البحث عن حالة LLC في Secretary of State" />;
}
