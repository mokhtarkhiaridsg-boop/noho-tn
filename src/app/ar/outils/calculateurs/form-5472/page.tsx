...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nohomailboxtunis.com/ar/outils/calculateurs/form-5472" },
};

export default function ArForm5472Page() {
  return <ArabicStub frHref="/fr/outils/calculateurs/form-5472" frTitleAr="حاسبة عقوبة Form 5472" />;
}
