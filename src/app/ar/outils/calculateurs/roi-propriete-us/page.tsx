...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://noho.tn/ar/outils/calculateurs/roi-propriete-us" },
};

export default function ArRoiPage() {
  return <ArabicStub frHref="/outils/calculateurs/roi-propriete-us" frTitleAr="حاسبة ROI العقار الأمريكي" />;
}
