...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://noho.tn/ar/outils/calculateurs/taxes-us-etat" },
};

export default function ArTaxesUsEtatPage() {
  return <ArabicStub frHref="/outils/calculateurs/taxes-us-etat" frTitleAr="الضرائب الأمريكية حسب الولاية" />;
}
