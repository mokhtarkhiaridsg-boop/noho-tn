...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nohomailboxtunis.com/ar/outils/calculateurs/stripe-fees" },
};

export default function ArStripeFeesPage() {
  return <ArabicStub frHref="/fr/outils/calculateurs/stripe-fees" frTitleAr="حاسبة رسوم Stripe مقابل Paddle" />;
}
