...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nohomailboxtunis.com/ar/outils/comparateurs/banques-us" },
};

export default function ArBanquesUsPage() {
  return <ArabicStub frHref="/fr/outils/comparateurs/banques-us" frTitleAr="مقارن البنوك الأمريكية" />;
}
