...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nohomailboxtunis.com/ar/outils/comparateurs/etats-llc" },
};

export default function ArEtatsLlcPage() {
  return <ArabicStub frHref="/fr/outils/comparateurs/etats-llc" frTitleAr="مقارن الولايات لشركة LLC" />;
}
