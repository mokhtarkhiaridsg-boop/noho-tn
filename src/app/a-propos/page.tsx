...
const breadcrumbs = breadcrumbJsonLd([
  ...
  { name: "À propos", url: "https://noho.tn/a-propos" },
]);
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://noho.tn/a-propos" },
};
    ...
    <>
      ...
      <section className="px-5 sm:px-6 py-14 sm:py-16" style={{ background: "#fff" }}>
        <div className="max-w-3xl mx-auto space-y-7 text-[15.5px] leading-relaxed" style={{ color: "rgba(45,16,15,0.85)" }}>
          ...
          <p>
            <strong>L&apos;édition Tunisie (noho.tn)</strong> est dédiée à
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              { t: "Storefront physique", b: "5062 Lankershim Blvd, ouvert au public. Pas une boîte virtuelle, pas une fiction." },
