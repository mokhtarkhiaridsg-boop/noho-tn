...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://noho.tn/blog/${article.slug}`,
      languages: {
        "fr-TN": `https://noho.tn/blog/${article.slug}`,
        "ar-TN": `https://noho.tn/ar/blog/${article.slug}`,
        "x-default": `https://noho.tn/blog/${article.slug}`,
      },
    },
    openGraph: {
      title: article.title,
      description: article.excerpt,
      url: `https://noho.tn/blog/${article.slug}`,
      type: "article",
...
export default async function ArticlePage({
  ...
  const url = `https://noho.tn/blog/${article.slug}`;
  const publisherGraph = {
    "@type": "Organization",
    "@id": "https://noho.tn/#org",
    name: "NOHO Mailbox",
    url: "https://noho.tn",
    logo: { "@type": "ImageObject", url: "https://noho.tn/icon.svg", width: 512, height: 512 },
  ...
  const articleJsonLd = {
    ...
    isPartOf: { "@type": "Blog", "@id": "https://noho.tn/blog" },
  };
  const breadcrumbJsonLd = {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Accueil", item: "https://noho.tn" },
      { "@type": "ListItem", position: 2, name: "Blog", item: "https://noho.tn/blog" },
      { "@type": "ListItem", position: 3, name: article.categoryLabel, item: `https://noho.tn/blog/categorie/${article.category}` },
