...
export function apostilleTnUs() {
  return (
    <>
      ...
      <ul>
        <li>
          <strong>RON (Remote Online Notarization)</strong> via un
          notaire californien sur appel vidéo Zoom. Coût ~80-150 USD.
          Pas besoin d&apos;apostille puisque la notarisation est faite
          directement aux USA. Le plus rapide (1-2 jours).
        </li>
        <li>
