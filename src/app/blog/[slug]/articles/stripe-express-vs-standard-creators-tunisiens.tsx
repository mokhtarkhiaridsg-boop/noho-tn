  ...
  return (
    <>
      ...
      <p>
        ...
        <Link href="/blog/form-w8ben-ligne-par-ligne">W-8BEN</Link>{" "}
      ...
      <p>
        ...
        standard via{" "}
        <Link href="/business">Solution Business LLC US</Link>. La
      ...
      <p>
        ...
        standard via LLC.{" "}
        <Link href="/appel">Réserve un appel.</Link> Gratuit, on dit
