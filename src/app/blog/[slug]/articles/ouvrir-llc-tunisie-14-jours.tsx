  ...
  return (
    <>
      ...
      <ol>
        ...
        <li>
          Notarisation à distance (RON) via un notaire californien sur
          appel vidéo — possible depuis la Tunisie, ~100 USD.
        </li>
        <li>
      ...
      <p>
        ...
        active le Plan B :{" "}
        <Link href="/blog/mercury-bank-depuis-tunis-dossier-renforce" className="font-bold underline" style={{ color: "#337485" }}>
