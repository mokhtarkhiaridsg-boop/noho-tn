...
import FrPage, { metadata as frMetadata } from "@/app/fr/outils/comparateurs/banques-us/page";

export const metadata: Metadata = {
  ...frMetadata,
  alternates: { canonical: "https://nohomailboxtunis.com/outils/comparateurs/banques-us" },
};
