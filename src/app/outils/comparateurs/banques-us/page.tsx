...
const breadcrumbs = breadcrumbJsonLd([
  ...
  { name: "Comparateurs", url: "https://noho.tn/outils#comparateurs" },
  { name: "Banques US", url: "https://noho.tn/outils/comparateurs/banques-us" },
]);
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://noho.tn/outils/comparateurs/banques-us" },
};
      ...
      <section className="px-5 sm:px-6 py-10" style={{ background: "#fef3c7" }}>
        <div className="max-w-3xl mx-auto text-[13.5px] leading-relaxed" style={{ color: "#422006" }}>
          ...
          <p>
            ...
            qu&apos;on fait :{" "}
            <Link href="/blog/mercury-bank-depuis-tunis-dossier-renforce" className="font-bold underline" style={{ color: "#92400e" }}>
