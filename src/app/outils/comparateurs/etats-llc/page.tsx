...
import FrPage, { metadata as frMetadata } from "@/app/fr/outils/comparateurs/etats-llc/page";

export const metadata: Metadata = {
  ...frMetadata,
  alternates: { canonical: "https://nohomailboxtunis.com/outils/comparateurs/etats-llc" },
};
