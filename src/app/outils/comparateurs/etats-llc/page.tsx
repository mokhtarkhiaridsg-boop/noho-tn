...
const breadcrumbs = breadcrumbJsonLd([
  ...
  { name: "États LLC", url: "https://noho.tn/outils/comparateurs/etats-llc" },
]);
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://noho.tn/outils/comparateurs/etats-llc" },
};
  ...
  return (
    <>
      ...
      <section className="px-5 sm:px-6 py-10" style={{ background: "#fff" }}>
        <div className="max-w-3xl mx-auto text-center">
          <Link
            href="/blog/wyoming-delaware-nouveau-mexique-choisir-etat-llc"
