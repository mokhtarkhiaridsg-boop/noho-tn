...
import FrPage, { metadata as frMetadata } from "@/app/fr/outils/comparateurs/cross-border/page";

export const metadata: Metadata = {
  ...frMetadata,
  alternates: { canonical: "https://nohomailboxtunis.com/outils/comparateurs/cross-border" },
};
