...
import FrPage, { metadata as frMetadata } from "@/app/fr/outils/lookups/form-1583/page";

export const metadata: Metadata = {
  ...frMetadata,
  alternates: { canonical: "https://nohomailboxtunis.com/outils/lookups/form-1583" },
};
