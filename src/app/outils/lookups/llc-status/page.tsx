...
import FrPage, { metadata as frMetadata } from "@/app/fr/outils/lookups/llc-status/page";

export const metadata: Metadata = {
  ...frMetadata,
  alternates: { canonical: "https://nohomailboxtunis.com/outils/lookups/llc-status" },
};
