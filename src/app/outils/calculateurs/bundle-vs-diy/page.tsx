...
import FrPage, { metadata as frMetadata } from "@/app/fr/outils/calculateurs/bundle-vs-diy/page";

export const metadata: Metadata = {
  ...frMetadata,
  alternates: { canonical: "https://nohomailboxtunis.com/outils/calculateurs/bundle-vs-diy" },
};
