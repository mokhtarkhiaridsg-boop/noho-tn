...
import FrPage, { metadata as frMetadata } from "@/app/fr/outils/calculateurs/roi-propriete-us/page";

export const metadata: Metadata = {
  ...frMetadata,
  alternates: { canonical: "https://nohomailboxtunis.com/outils/calculateurs/roi-propriete-us" },
};
