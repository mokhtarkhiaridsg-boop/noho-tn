...
import FrPage, { metadata as frMetadata } from "@/app/fr/outils/calculateurs/residence-fiscale/page";

export const metadata: Metadata = {
  ...frMetadata,
  alternates: { canonical: "https://nohomailboxtunis.com/outils/calculateurs/residence-fiscale" },
};
