...
import FrPage, { metadata as frMetadata } from "@/app/fr/outils/calculateurs/taxes-us-etat/page";

export const metadata: Metadata = {
  ...frMetadata,
  alternates: { canonical: "https://nohomailboxtunis.com/outils/calculateurs/taxes-us-etat" },
};
