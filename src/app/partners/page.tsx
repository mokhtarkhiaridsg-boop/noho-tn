...
const breadcrumbs = breadcrumbJsonLd([
  ...
  { name: "Programme affilié", url: "https://noho.tn/partners" },
]);
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://noho.tn/partners" },
};
...
const PARTNERS_FIT = [
  ...
  { t: "Comptables & avocats TN", d: "Tu as déjà des clients qui demandent une LLC US ? On t'envoie 20% net." },
