...
/* ═══════════════════════════════════════════════════════════════════
   DATA — Tounsi (derja, Latin script) mirror of the FR homepage.
   ═══════════════════════════════════════════════════════════════════ */
const DOORS = [
  {
    ...
    n: "01",
    accent: TEAL,
    eyebrow: "Pilier 01 · Adresse & Colis",
    title: "Adresse US & Colis",
    hook: "Nest9ablou Amazon, Shein, eBay — 9adhytek touselek 7ata el Tounes.",
    tag: "men 35 TND/chhar",
    Icon: AiMailbox,
  },
  {
    href: "/etudiants",
    n: "02",
    accent: GOLD,
    eyebrow: "Pilier 02 · Étudiants",
    title: "9raya fel Amerique",
    hook: "Ndezzou m3ak — mel Common App lel visa F-1.",
  ...
  },
  {
    ...
    n: "03",
    accent: GREEN,
    eyebrow: "Pilier 03 · Business",
    title: "Business",
    hook: "Tounsi w t7eb presence US?",
    tag: "LLC · EIN · adresse pro",
    Icon: AiStorefront,
  },
];
...
/* ═══════════════════════════════════════════════════════════════════
   DASHBOARD SNIPPET — floating member-dashboard card, derja labels.
   ═══════════════════════════════════════════════════════════════════ */
    ...
    >
      ...
      <div className="rounded-lg p-1.5 mb-1 flex items-center gap-1.5" style={{ background: "#FBF7F0", border: "1px solid #F0E7D8" }}>
        ...
        <div className="min-w-0">
          <p className="text-[9px] font-black truncate leading-tight" style={{ color: INK }}>UPS · Colis wsel</p>
          <p className="text-[7.5px] leading-tight" style={{ color: "#7A6050" }}>Scan · Ndezzouh l Tounes</p>
        </div>
      </div>
      <div className="rounded-lg p-1.5 flex items-center gap-1.5" style={{ background: "#FBF7F0", border: "1px solid #F0E7D8" }}>
        ...
        <div className="min-w-0">
          <p className="text-[9px] font-black truncate leading-tight" style={{ color: INK }}>Jwab · scanné</p>
          <p className="text-[7.5px] leading-tight" style={{ color: "#7A6050" }}>PDF fel dashboard mte3ek</p>
        </div>
      </div>
    </div>
  );
...
/* ═══════════════════════════════════════════════════════════════════
   ...
   CTAs, storefront photo + location + dashboard snippet, 3 piliers.
   ═══════════════════════════════════════════════════════════════════ */
export default function TounsiHomeHero() {
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[minmax(0,0.76fr)_minmax(0,1.24fr)] gap-9 sm:gap-5 lg:gap-9 items-center">
          ...
          <div className={`reveal-zoom ${mounted ? "is-in" : ""} relative max-w-[660px] w-full mx-auto sm:mx-0 sm:justify-self-end pb-5`} style={{ ["--reveal-delay" as string]: "140ms" }}>
            <div className="relative">
              ...
              <img
                src="/storefront.jpg"
                alt="El storefront NOHO fi 5062 Lankershim Blvd, North Hollywood, CA"
              ...
              <div className="absolute top-3 right-3">
                <OpenStatusPill compact solid openLabel="Ma7loul tawa" closedLabel="Msakker tawa" />
              </div>
        ...
        <div className="mt-5 flex flex-wrap items-center justify-center gap-x-3 gap-y-1">
          {[
            ...
            "Notaire californien",
            "Paiement en dinars · cabinet d'avocat",
            "9 snin khedma",
          ].map((t, i) => (
            ...
            >
              ...
              >
                ...
                <p className="relative z-[1] mt-2 mb-0.5 flex items-center justify-center gap-1.5">
                  ...
                  <span className="text-[9px] font-bold uppercase tracking-[0.16em]" style={{ color: d.accent }}>Pilier {d.n}</span>
                  <Flourish color={d.accent} />
                </p>
