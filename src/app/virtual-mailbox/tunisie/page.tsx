...
export const metadata: Metadata = {
  title: "Boîte virtuelle Tunisie — Adresse réelle à Tunis, scan + forwarding",
  description:
    "Boîte virtuelle à Tunis pour diaspora et résidents TN. Adresse réelle, scan de courrier, réception colis, réexpédition internationale. À partir de 50 TND/mois. Phase de pré-lancement.",
  alternates: { canonical: "https://noho.tn/virtual-mailbox/tunisie" },
};
    ...
    <>
      ...
      <section className="px-5 sm:px-6 py-14 sm:py-16 text-center" style={{ background: "#fff" }}>
        <div className="max-w-xl mx-auto">
          ...
          <p className="text-[14.5px] leading-relaxed mb-7" style={{ color: "rgba(45,16,15,0.75)" }}>
            On ouvre la boîte virtuelle Tunis aux premiers clients en
      ...
      <section className="px-5 sm:px-6 py-10" style={{ background: "#fef3c7" }}>
        <div className="max-w-3xl mx-auto text-[13.5px] leading-relaxed" style={{ color: "#422006" }}>
          ...
          <p>
            La boîte virtuelle Tunis n&apos;est pas encore opérationnelle.
