...
import { AiMailbox } from "@/components/AnimatedIcons";
import { breadcrumbJsonLd } from "@/lib/breadcrumb";

const breadcrumbs = breadcrumbJsonLd([
  { name: "Accueil", url: "https://noho.tn" },
  { name: "Boîte virtuelle", url: "https://noho.tn/virtual-mailbox" },
]);

const serviceJsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Boîte virtuelle US — NOHO",
...
export const metadata: Metadata = {
  title: "Boîte virtuelle US — Adresse réelle, scan, forwarding dès 35 TND/mois",
  description:
    "Adresse postale US réelle à Los Angeles. Scan de courrier le jour même via dashboard. Réception colis (Amazon, UPS, FedEx, DHL). Forwarding international vers la Tunisie. Trois forfaits en dinars : 35, 75, 150 TND/mois.",
  alternates: {
    canonical: "https://noho.tn/virtual-mailbox",
    languages: {
      "fr-TN": "https://noho.tn/virtual-mailbox",
      "ar-TN": "https://noho.tn/ar/virtual-mailbox",
      "x-default": "https://noho.tn/virtual-mailbox",
    },
  },
};
...
const IconMailboxSm: IconCmp = ({ className = "w-4 h-4" }) => (
  <svg viewBox="0 0 24 24" className={className} fill="none" aria-hidden="true">
    <rect x="3" y="10" width="18" height="9" rx="2" fill={CREAM} stroke={INK} strokeWidth="1.8" />
    <path d="M3 13 Q3 7 12 7 Q21 7 21 13" fill={CREAM} stroke={INK} strokeWidth="1.8" />
    <rect x="20" y="9" width="2" height="5" fill={BLUE} />
  </svg>
);
...
const PLANS = [
  {
    ...
    bullets: [
      ...
      ["Stockage 30 jours", "Au-delà : 1 TND/colis/jour"],
  ...
  },
  {
    ...
    bullets: [
      ...
      ["Stockage 60 jours", "Idéal pour acheteurs Amazon"],
    ],
    primary: true,
  },
  {
...
const USES: { Icon: IconCmp; t: string; b?: string; c?: string }[] = [
  ...
  { Icon: IconCard, t: "Activer Stripe, Mercury, Wise Business", b: "Ces fournisseurs exigent une adresse US réelle (pas une boîte virtuelle de mauvaise réputation). NOHO passe leurs vérifications." },
    ...
    <>
      ...
      <section className="px-5 sm:px-6 pt-12 sm:pt-20 pb-10 text-center" style={{ background: CREAM }}>
        <div className="max-w-3xl mx-auto">
          ...
          >
            <IconMailboxSm className="w-4 h-4" />
            Le produit principal · dès 35 TND/mois
          </span>
          ...
          <p className="text-[16px] leading-relaxed max-w-xl mx-auto mb-6" style={{ color: "rgba(45,16,15,0.78)" }}>
            Adresse postale US réelle à Los Angeles. Scan de courrier le jour
            même via dashboard. Réception colis (Amazon, UPS, FedEx, DHL).
            Forwarding international vers la Tunisie. Tarif en dinars.
          </p>
      ...
      {/* PRICING — STAMP CARDS */}
      <section className="px-7 sm:px-6 py-14 sm:py-20" style={{ background: CREAM }}>
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10 sm:mb-14">
            ...
            >
              3 forfaits, une adresse réelle
            </h2>
            <p className="mt-3 text-[15px]" style={{ color: "rgba(45,16,15,0.5)" }}>
              Annulables à tout moment. Forfait annuel = 2 mois offerts.
            </p>
          </div>
              ...
              <div key={p.name} className={`group ${p.primary ? "md:-mt-3" : ""}`}>
                <StampCard popular={p.primary}>
                  ...
                  <div className="text-center mb-2">
                    ...
                    >
                      {p.yearPrice} TND/an · Form 1583 inclus
                    </p>
                  </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-[1fr_auto] items-center gap-4">
              <div>
                ...
                <h2 className="font-extrabold text-[19px] sm:text-[22px] mb-2" style={{ fontFamily: "var(--font-baloo), sans-serif" }}>
                  Boîte virtuelle à Tunis arrive bientôt
                </h2>
