...
import FrPage, { metadata as frMetadata } from "@/app/fr/guides/plafond-carte-technologique/page";

export const metadata: Metadata = {
  ...frMetadata,
  alternates: { canonical: "https://nohomailboxtunis.com/guides/plafond-carte-technologique" },
};
