...
function computeResult(a: Record<string, string>): Result {
  ...
  if (revenue === "idea") {
    return {
      ...
      cta: { label: "Lire les guides pour préparer le terrain →", href: "/" },
      honestNote:
  ...
  if ((vc === "yes" || vc === "maybe") && activity === "saas") {
    return {
      ...
      cta: { label: "Réserver un appel pour confirmer →", href: "/appel" },
      honestNote:
  ...
  if (banking_history === "approved" && (activity === "services" || activity === "content")) {
    return {
      ...
      cta: { label: "Réserver l'appel pour cadrer le Suivi mensuel →", href: "/appel" },
    };
  }
  ...
  if (banking_history === "rejected") {
    return {
      ...
      cta: { label: "Réserver l'appel pour le Plan B →", href: "/appel" },
    };
  }
  ...
  if (
    ...
    return {
      ...
      cta: { label: "Réserver l'appel de 30 min →", href: "/appel" },
    };
  }
  ...
  if (activity === "ecom_physical") {
    return {
      ...
      cta: { label: "Réserver l'appel pour cadrer la logistique →", href: "/appel" },
    };
  }
  ...
  if (activity === "ecom_digital") {
    return {
      ...
      cta: { label: "Réserver l'appel pour évaluer →", href: "/appel" },
    };
  }
