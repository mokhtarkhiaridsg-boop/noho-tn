...
const agentItemListJsonLd = {
  ...
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Solution E-Commerce", url: "https://noho.tn/agent/ecom" },
    { "@type": "ListItem", position: 2, name: "Solution Étudiants", url: "https://noho.tn/agent/student" },
    { "@type": "ListItem", position: 3, name: "Solution Application Emploi", url: "https://noho.tn/agent/jobs" },
  ],
};
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://noho.tn/agent",
    languages: {
      "fr-TN": "https://noho.tn/agent",
      "ar-TN": "https://noho.tn/ar/agent",
      "x-default": "https://noho.tn/agent",
    },
  },
};
