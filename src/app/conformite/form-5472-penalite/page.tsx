...
import FrPage, { metadata as frMetadata } from "@/app/fr/conformite/form-5472-penalite/page";

export const metadata: Metadata = {
  ...frMetadata,
  alternates: { canonical: "https://nohomailboxtunis.com/conformite/form-5472-penalite" },
};
