...
const breadcrumbs = breadcrumbJsonLd([
  ...
  { name: "Suivi mensuel", url: "https://noho.tn/suivi-mensuel" },
]);
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://noho.tn/suivi-mensuel",
    languages: {
      "fr-TN": "https://noho.tn/suivi-mensuel",
      "ar-TN": "https://noho.tn/ar/suivi-mensuel",
      "x-default": "https://noho.tn/suivi-mensuel",
    },
  },
};
      ...
      <section className="px-5 sm:px-6 pt-12 sm:pt-20 pb-10 sm:pb-12" style={{ background: CREAM }}>
        <div className="max-w-3xl mx-auto">
          <nav className="text-[12px] mb-5 opacity-60" style={{ color: INK }}>
            <Link href="/" className="hover:underline">Accueil</Link> · <span>Suivi mensuel</span>
          </nav>
